        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img src="img/book.jpg" class="img-fluid w-100" alt="Image">
                    <div class="carousel-caption-1">
                        <div class="carousel-caption-1-content" style="max-width: 900px;">
                        <h2 class="text-white text-uppercase fw-bold mb-4 fadeInRight animated" data-animation="fadeInRight" data-delay="1s" style="animation-delay: 1s;" style="letter-spacing: 3px;">Мактаб даргоҳи бузургест, ки баробари ба он қадам ниҳодан, вуҷуди мо фараҳ меёбад ва аз ҳарфу пандҳои устодон баҳраманд мешавем.</h2>
                            
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="img/school.png" class="img-fluid w-100" alt="Image">
                    <div class="carousel-caption-2">
                        <div class="carousel-caption-2-content" style="max-width: 900px;">
                            <h2 class="text-white text-uppercase fw-bold mb-4 fadeInRight animated" data-animation="fadeInRight" data-delay="1s" style="animation-delay: 1s;" style="letter-spacing: 3px;">Мактаб макони илму дониш, маърифат, фарҳангу адаб ва хирад аст. Касе нест, ки дар ин даргоҳи муқаддас сабақ нагирифта бошад.</h2>
